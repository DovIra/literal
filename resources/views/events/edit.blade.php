    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="event_name" id="name"
                    value="{{ old('event_name', $event->event_name) }}"
                    class="w-full border-gray-300 rounded-md  focus:ring-blue-500 focus:border-blue-500" maxlength="50" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description"
                    class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" rows="4" required>{{ old('description', $event->description) }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="date" id="date"
                    ...
                    class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" min="{{ date('Y-m-d') }}" required>
            </div>
